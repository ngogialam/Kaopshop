                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="beta-products-list">
                                ...
                                <div class="col-sm-3">
                                    <div class="single-item">
                                        ...
                                        <div class="single-item-caption">
                                            ...
                                            <a class="beta-btn primary" href="{{route('chitietsanpham',$new->id)}}">Chi tiết <i
                            ...
                            <div class="row" style="width: 100px">{{ $new_product->links()}}</div>
                        ...
                        <div class="beta-products-list">
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="single-item">
                                            ...
                                            <div class="single-item-caption">
                                                <a class="add-to-cart pull-left" href="{{route('themgiohang',$new->id)}}"><i
                                                        class="fa fa-shopping-cart"></i></a>
                                                <a class="beta-btn primary" href="{{route('chitietsanpham',$spkm->id)}}">Chi tiết <i
                                                        class="fa fa-chevron-right"></i></a>
                                                <div class="clearfix"></div>
                                            </div>
                                        </div>
                                ...
                                @endforeach
                                <div class="row" style="width: 100px">{{$sanpham_khuyenmai->links()}}</div>
                            </div>
                        </div> <!-- .beta-products-list -->
                    </div>

    ...
    <div class="container">
        ...
        <div class="pull-right">
            <div class="beta-breadcrumb">
                <a href="{{route('trangchu')}}" style="font-weight:bold">Trang chủ</a> / <span>Đặt hàng</span>
            </div>
        </div>
                        ...
                        <div class="your-order-body" style="padding: 0px 10px">
                            <div class="your-order-item">
                              ...
                              @foreach($product_cart as $cart)
                                <!--  one item	 -->
                                    <div class="media">
                                        <img width="15%" src="source/image/product/{{$cart['item']['image']}}" alt="" class="pull-left">
                                        <div class="media-body">
                                            <p class="font-large">{{$cart['item']['name']}}</p>
                                            {{-- <span class="color-gray your-order-info">Color: Red</span> --}}
                                            <span class="color-gray your-order-info"> Số lương: {{$cart['qty']}}</span>
                                            <span class="color-gray your-order-info" style="font-weight:bold; color:red">Đơn Giá : {{number_format($cart['price']/$cart['qty'])}} đồng</span>
                                        </div>
                                    </div>
                                <!-- end one item -->
                                @endforeach
                            ...
                            <ul class="payment_methods methods">
                                ...
                                <li class="payment_method_cheque">
                                    ...
                                    <div class="payment_box payment_method_cheque" style="display: none;">
                                        ...
                                        <br>- Chủ TK: Nguyễn A
                                        <br>- Ngân hàng ACB, Chi nhánh Hai Bà Trưng Hà Nội.
                                    </div>						
                                </li>
